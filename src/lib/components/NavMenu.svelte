...
{#snippet menuIcon(icon: string)}
	...
	{:else if icon === 'agent'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5">
			<path
				d="M13.024 9.25c.47 0 .827-.433.637-.863a4 4 0 00-7.322 0c-.19.43.168.863.637.863h6.048zM10 2a1 1 0 011 1v.268a2 2 0 011.818 1.217l.286-.16a1 1 0 011 1.732l-.286.16c.103.326.161.673.161 1.033v.55a1 1 0 01-2 0v-.55a1.5 1.5 0 10-3 0v.55a1 1 0 01-2 0v-.55c0-.36.058-.707.16-1.033l-.285-.16a1 1 0 111-1.732l.286.16A2 2 0 019 3.268V3a1 1 0 011-1z"
			/>
			<path
				d="M3 13.75a.75.75 0 01.75-.75h12.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75zM3 16.25a.75.75 0 01.75-.75h12.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z"
			/>
		</svg>
	{:else if icon === 'image'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5">
	...
	{:else if icon === 'recipe'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5">
			<path
				d="M3.505 2.365A41.369 41.369 0 019 2c1.863 0 3.697.124 5.495.365 1.247.167 2.18 1.108 2.435 2.268a4.45 4.45 0 00-.577-.069 3.36 3.36 0 00-.618.016C14.813 3.612 13.602 2.75 12 2.75c-1.927 0-3.303 1.203-3.303 2.75S10.073 8.25 12 8.25c1.281 0 2.318-.564 2.895-1.408a2.96 2.96 0 001.07-.174c-.196 1.602-1.444 2.83-3.088 3.088A3.252 3.252 0 0110 12.25a3.252 3.252 0 01-2.877-2.494C5.31 9.349 4 7.775 4 5.75c0-.222.015-.44.044-.652A2.466 2.466 0 013.505 2.365z"
			/>
			<path
				d="M9.778 14.768A17.888 17.888 0 003 14c-.247 0-.492.004-.736.012A2 2 0 001 16.012V18a1 1 0 001.029.999c2.635-.088 5.212-.478 7.712-1.148a.5.5 0 00.037-.083V14.768zM10 17.646V14.768c.796.152 1.608.27 2.432.352.27.027.487.251.487.523v2.756a.502.502 0 01-.487.477 28.679 28.679 0 01-2.432-.23zM14.486 15.168c.884.042 1.777.05 2.678.021A1.999 1.999 0 0019 13.19v-1.178a2 2 0 00-1.736-1.982 18.003 18.003 0 01-2.778-.364v5.502z"
			/>
		</svg>
	{:else if icon === 'd20'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5">
			<path
				d="M10 1L1.5 6v8L10 19l8.5-5V6L10 1zm0 2.2L15.5 6.5 10 10.5 4.5 6.5 10 3.2zM3 7.5l6 3.8v6.5l-6-3.5V7.5zm8 10.3v-6.5l6-3.8v6.8l-6 3.5z"
			/>
		</svg>
	{:else if icon === 'brain'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5">
